...
const char USAGE_SCAN[] = "Scan for devices. Usage: scan [ ( [ <ssid> ] WIFI ) | BT | BLE [ PURGE ( RSSI [ <maxRSSI> ] | AGE [ <minAge> ] | UNNAMED | UNSELECTED | NONE )+ ] | OFF ]";
...
const char USAGE_VIEW[] = "List available targets. Usage: view ( ( AP [ selectedSTA ] ) | ( STA [ selectedAP ] ) | BT [ SERVICES [ KNOWN | UNKNOWN ] ] | SORT ( AGE | RSSI | SSID ) )+";
...
const char USAGE_CLEAR[] = "Clear stored APs, STAs or HCIs. Usage: clear ( AP | STA | BT [ SERVICES ] | ALL )";
...
const char USAGE_PURGE[] = "Purge cached devices based on criteria. Usage: purge [ AP | STA | BT | BLE ]+ [ RSSI [ <maxRSSI> ] | AGE [ <minAge> ] | UNNAMED | UNSELECTED | NONE ]+";
...
const char SHORT_SCAN[] = "scan [ ( [ <ssid> ] WIFI ) | BT | BLE [ PURGE ( RSSI [ <maxRSSI> ] | AGE [ <minAge> ] | UNNAMED | UNSELECTED | NONE )+ ] | OFF ]";
...
const char SHORT_VIEW[] = "VIEW ( ( AP [ selectedSTA ] ) | ( STA [ selectedAP ] ) | BT [ SERVICES [ KNOWN | UNKNOWN ] ] | SORT ( AGE | RSSI | SSID ) )+";
char SHORT_SELECT[] = "select ( AP | STA | BT ) <id>+ sep. ~";
const char SHORT_SELECTED[] = "selected ( AP | STA | BT )";
const char SHORT_CLEAR[] = "clear ( AP | STA | BT [ SERVICES ] | ALL )";
