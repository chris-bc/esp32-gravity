...
const char USAGE_SCAN[] = "Scan for devices. Usage: scan [ ( [ <ssid> ] WIFI ) | BT | BLE [ PURGE ( RSSI | AGE | UNNAMED | UNSELECTED | NONE )+ ] | OFF ]";
...
const char SHORT_SCAN[] = "scan [ ( [ <ssid> ] WIFI ) | BT | BLE [ PURGE ( RSSI | AGE | UNNAMED | UNSELECTED | NONE )+ ] | OFF ]";
