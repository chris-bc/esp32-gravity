...
const char SHORT_MANA[] = "Mana attack. Usage: mana [ CLEAR ] [ VERBOSE ] [ LOUD ] [ AUTH [ NONE | WEP | WPA ] ] [ ON | OFF ]";
...
const char USAGE_MANA[] = "mana [ CLEAR ] [ VERBOSE ] [ LOUD ] [ AUTH [ NONE | WEP | WPA ] ] [ ON | OFF ]";
